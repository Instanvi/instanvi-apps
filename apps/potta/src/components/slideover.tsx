      ...
      >
        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            <div className="pointer-events-none fixed inset-x-0 top-0 flex max-h-full justify-center">
              <DialogPanel
                transition
                className="pointer-events-auto border-b w-screen max-w-full transform transition duration-500 ease-in-out data-[closed]:-translate-y-full sm:duration-700"
              >
                <div className="flex h-full flex-col overflow-hidden bg-gray-50 py-6 shadow-xl">
                  <div className="">
                    <div className="flex items-start py-2 w-full border-b justify-between">
                      <DialogTitle className="text-xl leading-6 px-4 text-gray-900">
                        {title}
                      </DialogTitle>
